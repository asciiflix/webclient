    ...
    render() {
        return (
            <div className="video-preview-container">
                <Link to={"/watch/" + this.props.uuid} className="video-preview-link"><div className="video-preview-thumbnail"></div></Link>
                <p className="video-preview-title"><Link to={"/watch/" + this.props.uuid} className="video-preview-link">{this.props.title}</Link> <Link to="/user/{userName}" className="video-preview-creator">- {this.state.creator_name}</Link></p>
            </div>
        )
    }
}
